...
/*
  ...
  컴포넌트가 최초로 호출될 때 그리고 def(dependencies)가
  업데이트될 때 이펙트를 실행한다.
*/
...
function getProfile() {
  ...
  const DATA = {
    username: "살려줘",
    avatar: "https://i.ytimg.com/vi/QPw6j_nB7P0/maxresdefault.jpg",
    bio: "정신이 좀 드는가"
  }
